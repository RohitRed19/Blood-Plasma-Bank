...
<br>
	...
	<br>
	<center><h1> PATIENT'S LIST </h1></center>
<table border="1">
<tr>
<?php 
 require 'connection.php';
 $conn    = Connect();
 $psw	= $conn->real_escape_string($_POST['psw1']);
 $db = "patient";
 $sql ="SELECT patient.patient_id,first_name,last_name,blood_group,patient_disease FROM patient INNER JOIN patient_blood_usage Where patient_blood_usage.patient_id=patient.patient_id AND patient_blood_usage.hospital_id='".$psw."'";
